...
public class register extends Activity {
	...
	EditText editDate; // set Date after click edittext and it throw widget set
						// calendar
	TextView LoginBack;
	// ------------ set calendar---------------------------------------------
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LoginBack = (TextView) findViewById(R.id.link_to_login); // link click
																	// will back
																	// to
																	// activity
																	// login
		...
		editDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(register.this, d, cal.get(Calendar.YEAR),
						cal.get(Calendar.MONDAY), cal
